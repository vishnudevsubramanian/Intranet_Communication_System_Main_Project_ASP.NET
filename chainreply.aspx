<%@ Page Language="C#" AutoEventWireup="true" CodeFile="chainreply.aspx.cs" Inherits="chainreply" %>
    ...
    for (i = 0; i < ds.Tables[0].Rows.Count; i++)
    {
     ...
     %>
         ...
         %>
                                ...
                                <tr>
                                    <td class="style13">
                                        <asp:Button ID="Button2" runat="server" Text="SEND" Width="67px" onclick="Button2_Click" 
                                           />
                                    </td>
                                    <td class="style3">
                                        &nbsp;</td>
