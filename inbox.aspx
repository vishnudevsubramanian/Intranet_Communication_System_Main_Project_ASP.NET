 			...
 			<!-- / MENU CONTAINER \ -->
				 <div class="menuCntr">
				   <ul>
                    ...
                    <% DatabaseAccess da00 = new DatabaseAccess();
                       System.Data.DataSet ds00 = new System.Data.DataSet();
                       ds00 = da00.getData("select * from tbl_user where user_id=" + Session["FromUserID"]);
					...
					<li style="background:none;"><a href="blanklogout.aspx">Log out</a></li>
				       <li>
                           <img alt="" src="UserImages/<%=ds00.Tables[0].Rows[0].ItemArray.GetValue(10).ToString()%> "style="height: 30px; width:50px"/>
                           <table class="style1">
                               <tr>
                                   <td style="font-family: 'Times New Roman', Times, serif; font-size: 15px; color: #CC3300; font-weight: bold;">
                                      <%=ds00.Tables[0].Rows[0].ItemArray.GetValue(1).ToString()%> </td>
                               </tr>
                           </table>
                       </li>
                   ...
                   if (ds.Tables[0].Rows.Count > 0)
                   {
                       for (i = 0; i < ds.Tables[0].Rows.Count; i++)
                       {
                           ...
                           if (ds1.Tables[0].Rows.Count > 0) // if msg has replies
                           {
                               for (int j = 0; j < 1; j++)
                               {
                                   if(int.Parse(ds1.Tables[0].Rows[j].ItemArray.GetValue(3).ToString())==0 && int.Parse (ds1.Tables[0].Rows[j].ItemArray.GetValue(2).ToString())==int.Parse(Session["FromUserID"].ToString() ))
                                   {
                                   ...
                                   %>
                                                                                             ...
                                                                                             <td class="style14"><%=ds.Tables[0].Rows[i].ItemArray.GetValue(2).ToString()%>
                                                                                            </td>
                                                                                             <td class="style14"><%=ds.Tables[0].Rows[i].ItemArray.GetValue(3).ToString()%>
                                                                                               </td>
                                                                                              <td class="style15" colspan="2">
                                                                                                 <a href="DeleteInboxMsg.aspx?msg_id=<%=ds.Tables[0].Rows[i].ItemArray.GetValue(0).ToString() %>"> del</a></td>
                                                                                             </tr>
                                                                                       <%}
                           ...
                           else if (int.Parse(ds.Tables[0].Rows[i].ItemArray.GetValue(4).ToString()) == int.Parse(Session["FromUserID"].ToString()))
                           {
                                   ...
                                   
                               {
                                   ...
                                   %>
                                                                                             ...
                                                                                             <td class="style10"> <%=ds.Tables[0].Rows[i].ItemArray.GetValue(2).ToString()%>
                                                                                            </td>
                                                                                             <td class="style10"> <%=ds.Tables[0].Rows[i].ItemArray.GetValue(3).ToString()%>
                                                                                              </td>
                                                                                              <td class="style11">
                                                                                                   <a href="DeleteInboxMsg.aspx?msg_id=<%=ds.Tables[0].Rows[i].ItemArray.GetValue(0).ToString() %>"> del</a></td>
