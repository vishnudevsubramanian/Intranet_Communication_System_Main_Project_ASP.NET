<%@ Page Language="C#" AutoEventWireup="true" CodeFile="composemsg.aspx.cs" Inherits="composemsg" %>
                ...
                &nbsp;<table class="style1">
                    <tr>
                        <td class="style15" colspan="2" 
                            style="font-family: 'Times New Roman', Times, serif; font-size: 21px; font-weight: bold; color: #CC3300;">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                            COMPOSE MAIL</td>
                    </tr>
                    <tr>
                        <td class="style15" 
                            ...
                            To</td>
                        <td class="style16">
                            <asp:TextBox ID="tomailid" runat="server" Width="250px" 
                                ontextchanged="TextBox1_TextChanged" ToolTip="Recipients"></asp:TextBox>
                    ...
                    <tr>
                        <td class="style3" colspan="2">
                            <asp:TextBox ID="composemessage" runat="server" Width="468px" Height="314px" 
