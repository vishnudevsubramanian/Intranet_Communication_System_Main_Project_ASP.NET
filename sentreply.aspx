<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sentreply.aspx.cs" Inherits="sentreply" %>
...
<%
    ...
    DatabaseAccess da = new DatabaseAccess();
    System.Data.DataSet ds = new System.Data.DataSet();
    ds = da.getData("select tbl_reply.reply_id,tbl_reply.reply_message,tbl_reply.date,tbl_user.name from tbl_reply,tbl_user where tbl_reply.from_id=tbl_user.user_id and tbl_reply.msg_id =" + Request.QueryString.Get("msg_id").ToString());
    ...
    for (i = 0; i < ds.Tables[0].Rows.Count; i++)
    {
     ...
     %>
                  ...
                  <table class="style1">
                      <tr>
                          <td class="style2" 
                              style="font-family: 'Times New Roman', Times, serif; font-size: 16px; color: #000000">
                              <%=ds.Tables[0].Rows[i].ItemArray.GetValue(3).ToString() %> wrote:</td>
                          <td style="font-family: 'Times New Roman', Times, serif; font-size: 16px; color: #000000">
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                          <a href="MessageAttachments/<%=ds1.Tables[0].Rows[j].ItemArray.GetValue(2).ToString()%>" 
                                              style="font-family: 'Times New Roman', Times, serif; font-size: 16px; color: #000000"> Download</a></td>
                                  </tr>
...
<%
    ...
    ds2 = da.getData("select * from tbl_mails where msg_id=" + Request.QueryString.Get("msg_id").ToString());
                  ...
                  <table class="style1">
                      <tr>
                          <td class="style2" 
                              ...
                              you wrote:</td>
                          <td style="font-family: 'Times New Roman', Times, serif; font-size: 16px; color: #000000">
                              on <%=ds2.Tables[0].Rows[0].ItemArray.GetValue(6).ToString () %></td>
                      </tr>
                      <tr>
                          <td class="style2" 
                              style="font-family: 'Times New Roman', Times, serif; font-size: 16px; color: #000000">
...
ds4 = da.getData("select * from tbl_attachments where message_id=" + Request.QueryString.Get("msg_id").ToString());
                              ...
                              if (count1 > 0)
                              {
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                          <a href="MessageAttachments/<%=ds4.Tables[0].Rows[m].ItemArray.GetValue(2).ToString()%>" 
                                              style="font-family: 'Times New Roman', Times, serif; font-size: 16px; color: #000000"> Download</a></td>
                                  </tr>
