<%@ Page Language="C#" AutoEventWireup="true" CodeFile="showmysolutionafterlike.aspx.cs" Inherits="showmysolutionafterlike" %>
                ...
                <table class="style1">
                    ...
                    <tr>
                        <td colspan="2" 
                            style="font-family: 'Times New Roman', Times, serif; font-size: large; color: #CC3300; font-weight: bold">
                            &nbsp;
                            <asp:DropDownList ID="DropDownList1" runat="server" Height="36px" Width="463px" 
                                AutoPostBack="True">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    ...
                    <tr>
                     ...
                     <%
                         try
                         {
                             ...
                             ds = da.getData("select * from tbl_answers where q_id=" + Session["id"]);
                    ...
                    <tr>
                        <td 
                            ...
                            style="font-family: 'Times New Roman', Times, serif; font-size: large; color: #CC3300; font-weight: bold" 
                            colspan="2">posted by:        <%=ds.Tables[0].Rows[i].ItemArray.GetValue(4).ToString()%>
                            </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td 
                            ...
                            style="font-family: 'Times New Roman', Times, serif; font-size: large; color: #CC3300; font-weight: bold">
                            <a href="likeown.aspx?ans_id=<%=ds.Tables[0].Rows[i].ItemArray.GetValue(0).ToString() %>&qid=<%=ds.Tables[0].Rows[i].ItemArray.GetValue(1).ToString() %>">like</a></td>
                    </tr>
                    ...
                    <tr>
                        <td class="style20">
                            <%=ds.Tables[0].Rows[i].ItemArray.GetValue(5).ToString()%> likes</td>
                        <td class="style18">
                            </td>
                    </tr>
