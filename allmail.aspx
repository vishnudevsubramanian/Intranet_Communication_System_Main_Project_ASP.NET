<%@ Page Language="C#" AutoEventWireup="true" CodeFile="allmail.aspx.cs" Inherits="allmail" %>
...
else
{
          ...
          <div id="rightCntr">
              <div class="txtbox">
                  <table class="style1">
                      ...
                      <tr>
                          <td colspan="2">
                              <asp:TextBox ID="TextBox1" runat="server" Width="356px" placeholder="enter subject to search"></asp:TextBox>
                              <asp:Button ID="Button1" runat="server" Height="17px" Text="search" 
                                  onclick="Button1_Click" />
                          </td>
                      </tr>
                      <tr>
                          <td style="font-size: 21px; color: #CC3300; font-weight: bold;">
                              <br />
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              ALL MAILS</td>
                          <td>
 ...
 <%
                ...
                DatabaseAccess da = new DatabaseAccess();
                System.Data.DataSet ds = new System.Data.DataSet();
                ds = da.getData("select tbl_user.name,tbl_mails.from_user_id,tbl_mails.to_user_id,tbl_mails.subject,tbl_mails.date,tbl_mails.msg_id from tbl_user,tbl_mails where tbl_user.user_id =tbl_mails.from_user_id and (tbl_mails.to_user_id=" + Session["FromUserID"].ToString() + " or tbl_mails.from_user_id=" + Session["FromUserID"].ToString() + ") order by date desc" );
              int i;
              //int type = 0;    //type=0 if mail is recieved,type=1 if mail is sent from current login
                ...
                for(i=0;i<ds.Tables[0].Rows.Count;i++)
                {
                    ...
                    if (int.Parse(Session["FromUserID"].ToString()) == int.Parse(ds.Tables[0].Rows[i].ItemArray.GetValue(1).ToString()))
                    {
                        DatabaseAccess da1 = new DatabaseAccess();
                        System.Data.DataSet ds1 = new System.Data.DataSet();
                       ds1 = da1.getData("select tbl_user.name from tbl_user,tbl_mails where tbl_user.user_id=tbl_mails.to_user_id and tbl_user.user_id=" + ds.Tables[0].Rows[i].ItemArray.GetValue(2).ToString());
                       
                           name = "to: " + ds1.Tables[0].Rows[0].ItemArray.GetValue(0).ToString();
                       
                    
                    }
                    else if (int.Parse(Session["FromUserID"].ToString()) == int.Parse(ds.Tables[0].Rows[i].ItemArray.GetValue(2).ToString()))
                    {
                        name = ds.Tables[0].Rows[i].ItemArray.GetValue(0).ToString();
                  ...
                  <tr>
                     ...
                     <%
                         ...
                         ds4 = da4.getData("select * from tbl_mails where from_user_id=" + Session["FromUserID"].ToString() + " and msg_id=" + ds.Tables[0].Rows[i].ItemArray.GetValue(5).ToString());   //checking whether user is sending or recieving mails
                     ...
                     %>
                        ...
                        <a href="sentreply.aspx?msg_id=<%=ds.Tables[0].Rows[i].ItemArray.GetValue(5).ToString() %>">     <%=name%></a></td>
                     <% 
}
                             else
                             {
                         %>
                        <a href="sentopen.aspx?msg_id=<%=ds.Tables[0].Rows[i].ItemArray.GetValue(5).ToString() %>">     <%=name%></a></td>
                        <%
}
                         ...
                         %>
                         <a href="replyinbox.aspx?msg_id=<%=ds.Tables[0].Rows[i].ItemArray.GetValue(5).ToString() %>">     <%=name%></a></td>
                        <%
                               
}
                             else
                             { %>
                           <a href="viewinbox.aspx?msg_id=<%=ds.Tables[0].Rows[i].ItemArray.GetValue(5).ToString() %>">     <%=name%></a></td>
                        <%
}
                         }
                     %>
                        ...
                        <td style="font-family: 'Times New Roman', Times, serif; font-size: medium; font-weight: 100; font-style: normal">
                           <a href="DeleteInboxMsg.aspx?msg_id=<%=ds.Tables[0].Rows[i].ItemArray.GetValue(5).ToString() %>"> del</a></td>
