<%@ Page Language="C#" AutoEventWireup="true" CodeFile="trashviewinbox.aspx.cs" Inherits="trashviewinbox" %>
                                        ...
                                        %>
                                            ...
                                            <td>
                                                <a href="chat.aspx?contact_user_id=<%=ds.Tables[0].Rows[i].ItemArray.GetValue(0).ToString()%>" 
                                                    style="font-family: 'Times New Roman', Times, serif; font-size: medium; font-style: inherit">
                                                <%=ds.Tables[0].Rows[i].ItemArray.GetValue(1).ToString()%></a>
                                            </td>
                                        </tr>
                                        <% 
          ...
          <div id="rightCntr">
              <div class="txtbox">
                  ...
                  <%
                      ...
                      ds8 = da8.getData("select tbl_trashmail.msg_id,tbl_trashmail.subject,tbl_trashmail.message,tbl_trashmail.date,tbl_trashmail.open_status,tbl_user.name from tbl_trashmail,tbl_user where msg_id=" + Request.QueryString.Get("msg_id").ToString()+" and  tbl_trashmail.to_user_id=tbl_user.user_id");
